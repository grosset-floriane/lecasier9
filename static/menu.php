<div class="sommaire">
                ...
                <header class="header">
                    <a href="/?r=welcome"><img class="logo" src="img/logo.png" alt=""/></a>
                </header>

                <nav>
                    <ul class="nav">
                        <li class="texte">Galerie Web gérée par des étudiants en deuxième année à l'Ecole Supérieure d'Art et Média de Caen.</li>
                        <li class="lien"><a class="lien" href="/?r=welcome">Accueil</a></li>
